---
name: op-redmine-worklog-sync
description: 同步 OpenProject 项目条目到 Redmine，或查询 OpenProject 项目的条目、工时、成员等信息。触发场景包括：同步工时、同步条目、查询项目成员、查询工时记录、openproject 到 redmine、查询 openproject 项目。
author: courser.chen
version: 1.0.0
keywords: openproject, redmine, sync, work-package, time-entry, query, 查询
